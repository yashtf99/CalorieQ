...
from app.schemas.food_item import CustomFoodItemIn, FoodItemDetailOut, FoodItemSearchOut, FoodPortionOut
...
def search_food_items(
    ...
    items, total = food_service.search_food_items(db, q, source, page, page_size)
